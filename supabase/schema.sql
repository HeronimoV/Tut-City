...
CREATE POLICY "Users can view own solves" ON public.solves FOR SELECT USING (true);
CREATE POLICY "Users can insert own solves" ON public.solves FOR INSERT WITH CHECK (true);
CREATE POLICY "Users can view own concept scores" ON public.concept_scores FOR SELECT USING (true);
CREATE POLICY "Users can insert own concept scores" ON public.concept_scores FOR INSERT WITH CHECK (true);
CREATE POLICY "Users can update own concept scores" ON public.concept_scores FOR UPDATE USING (true);
CREATE POLICY "Users can view own weaknesses" ON public.user_weaknesses FOR SELECT USING (true);
CREATE POLICY "Users can insert own weaknesses" ON public.user_weaknesses FOR INSERT WITH CHECK (true);
CREATE POLICY "Users can update own weaknesses" ON public.user_weaknesses FOR UPDATE USING (true);
